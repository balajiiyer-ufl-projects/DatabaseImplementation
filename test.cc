...
void q5 () {
    ...
    cout<<"Create tmp file"<<endl;
    //	cout<<"WriteOut";
	SF_ps.Run (dbf_ps, _ps, cnf_ps, lit_ps);
    //	cout<<"Executed SelectFile Run"<<endl;
	P_ps.Run (_ps, __ps, keepMe, numAttsIn, numAttsOut);
    //	cout<<"Executed Project Run and executing Duplicate"<<endl;
	D.Run (__ps, ___ps,__ps_sch);
    //	cout<<"Finished duplicate and beg writeout"<<endl;
...
void q6 () {
    ...
    int whichAttr[MAX_ANDS];
    whichAttr[0] = 3;
    Type whichType[MAX_ANDS];
    whichType[0] = Int;
    grp_order.SetAttributeMetadata(1,whichAttr,whichType);
